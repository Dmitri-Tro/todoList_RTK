...
test("correct todolist should be removed", () => {
    const endState = todolistsReducer(
        startState,
        todolistsThunks.removeTodolist.fulfilled({ id: todolistId1 }, "requiredId", { todolistId: todolistId1 }),
    );
...
test("correct todolist should be added", () => {
    ...
    const endState = todolistsReducer(
        startState,
        todolistsThunks.addTodolist.fulfilled({ todoList: todolist }, "requiredId", { title: "New Todolist" }),
    );
